...
const CreatePost = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if(form.prompt && form.photo){
            ...
            try{
                const response = await fetch('https://imagine-ai-eta.vercel.app/api/v1/post', {
                    method: 'POST',
                    headers: {
    ...
    const generateImage = async () => {
        if(form.prompt){
            try{
                ...
                const response = await fetch('https://imagine-ai-eta.vercel.app/api/v1/dalle',{
                    method: 'POST',
                    headers: {
                        'Content-Type' : 'application/json',
                    },
                ...
                console.log(data)
                setForm({ ...form, photo: `data:image/webp;base64,${data.photo}` })
            }catch (err){
                alert(err)
            }finally{
